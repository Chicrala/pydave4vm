...
VTest:
This version will try to emulate the v4-1 version but running for single
potentially problematic fits files in a test database so that the errors can
be studied here and then carried on to the next version.
...
if __name__ == '__main__':
    ...
    downloaded = '/Users/andrechicrala/Downloads/test/'
    
    vel4vm = call_v4(downloaded = downloaded)
